...
export const translations = {
    en: {
        ...
        aiSettingsDesc: 'Provide your AI API Key (GLM-4.7) to enable AI-powered stock analysis.',
    ...
    tr: {
        ...
        aiSettingsDesc: 'Yapay zeka analizini etkinleştirmek için AI API Anahtarınızı (GLM-4.7) girin.',
