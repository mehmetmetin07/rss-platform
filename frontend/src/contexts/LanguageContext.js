...
export const translations = {
    en: {
        ...
        aiSettingsDesc: 'Provide your Gemini API Key to enable AI-powered stock analysis.',
        currentKey: 'Current Key',
        noKeyFound: 'No API Key found',
        saveKey: 'Save API Key',
        keySaved: 'API Key saved successfully!',
        keyRemoved: 'API Key removed.',
        analyzeAi: '✨ Analyze with Gemini',
        aiAnalysis: 'AI Market Analysis',
        aiDisclaimer: 'This analysis is generated by AI based on the news below. It is NOT financial advice.',
        analyzing: 'Analyzing market sentiment...',
        newsReferences: 'Referenced News Context',
    ...
    tr: {
        ...
        // Settings & AI
        aiSettings: 'Yapay Zeka Yapılandırması',
        aiSettingsDesc: 'Yapay zeka analizini etkinleştirmek için Gemini API Anahtarınızı girin.',
        currentKey: 'Mevcut Anahtar',
        noKeyFound: 'Anahtar Bulunamadı',
        saveKey: 'Anahtarı Kaydet',
        keySaved: 'Anahtar başarıyla kaydedildi!',
        keyRemoved: 'Anahtar silindi.',
        analyzeAi: '✨ Gemini İle Analiz Et',
        aiAnalysis: 'Yapay Zeka Piyasa Analizi',
        aiDisclaimer: 'Bu analiz aşağıdaki haberlere dayanarak yapay zeka tarafından üretilmiştir. Yatırım tavsiyesi DEĞİLDİR.',
        analyzing: 'Piyasa duyarlılığı analiz ediliyor...',
        newsReferences: 'Referans Alınan Haberler',
        ...
        'Consumer Defensive': 'Tüketim (Defansif)',
        'Industrials': 'Sanayi',
...
export function LanguageProvider({ children }) {
    ...
    const fetchExchangeRates = async () => {
        try {
            ...
            if (result.success && result.rates && result.rates.TRY) {
                setExchangeRate(result.rates.TRY);
            }
        } catch (error) {
    ...
    const tSector = (sector) => {
        return translations[language][sector] || sector;
    };

    return (
        <LanguageContext.Provider value={{ language, setLanguage: changeLanguage, exchangeRate, t, tSector }}>
            {children}
